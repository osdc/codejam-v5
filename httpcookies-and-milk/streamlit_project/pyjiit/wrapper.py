...
class Webportal:
    ...
    # New method to fetch student grades
    @authenticated
    def get_grades(self, semester: Semester):
        """
        :param semester: A Semester object
        :returns: A dictionary with grade data
        :raises APIError: Raised for generic API error
        """
        ENDPOINT = "/studentgrades/getstudentgrades"
    ...
    @authenticated
    def get_cgpa_report(self, header: AttendanceHeader):
